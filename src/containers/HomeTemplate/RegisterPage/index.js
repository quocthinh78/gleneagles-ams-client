      ...
      <div className={classes.main}>
        <Container className={classes.title}>
          ...
          <p className={classes.subTitle}>
            Registration will be closed on 12 Aug 2022 or when all seats are
            filled.
          </p>
        </Container>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <input
                ...
                name="mcrNumber"
                ref={(element) => {
                  inputRefs.current["mcrNumber"] = element;
                }}
                maxLength={6}
                value={mcrNumber}
            ...
            >
              ...
              <PhoneInput
                ...
                name={phoneNumber}
                ref={(element) => {
                  inputRefs.current["phoneNumber"] = element;
                }}
                value={phoneNumber}
                onChange={(val) => {
                  setPhoneNumnber(val || "");
        ...
        <MapInfo>
          ...
          <div className="info">
            ...
            <div className="address">
              <h2>Address:</h2>
              <h3>
                Shangri-la Singapore, Island Ballroom, Level 1<br />
                22 Orange Grove Road 258350 Singapore
              </h3>
            </div>
            <div className="bus">
              <h2>Bus:</h2>
              <h3>106, 111, 132, 174, 190, 502, 7B, 972</h3>
            </div>
            <div className="MRT">
              <h2>MRT:</h2>
              <h3>
                Please alight at Orchard Station and board the hotel shuttle bus
                from Orchard Station Exit B. (Complimentary shuttle service is
                available daily at 11am, 12pm, 1pm and 2pm)
              </h3>
            </div>

            <p>
              Complimentary parking is limited, Carpark availability is based on
              first come first served basis.
            </p>
          </div>
        </MapInfo>
        <CPModalImagePopup
          modalState={openImagePopup}
          onBlur={() => setOpenImagePopup(false)}
        >
          <img src={imageMap} alt="map img" />
        </CPModalImagePopup>
        <CPModalPopup
          modalState={popupTerm}
          onBlur={() => setPopupTerm(false)}
          bgColor="#0A7598"
        >
          <BoxContent>
            <h1>TERMS &amp; CONDITIONS</h1>
            <p>
              You are not allowed to record and/or distribute any recordings of
              the seminar. Please click the checkbox if you understand and agree
